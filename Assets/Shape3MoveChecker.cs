...
public class Shape3MoveChecker : MonoBehaviour
{
    ...
    private void CheckMoveDown()
    {
        ...
        {
            if (gridHandler.GridArray[Mathf.RoundToInt((pos.x-6) / 10), Mathf.RoundToInt((pos.z - 10) / 10)] == 2)
            {
                gridHandler.SetIsMovementEnded(true);
                Debug.Log("Movement Ended");
            }
        ...
        {
            if (gridHandler.GridArray[Mathf.RoundToInt(pos.x / 10), Mathf.RoundToInt((pos.z ) / 10)] == 2)
            {
                gridHandler.SetIsMovementEnded(true);
                Debug.Log("Movement Ended");
            }
