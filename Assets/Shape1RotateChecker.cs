...
public class Shape1RotateChecker : MonoBehaviour
{
    ...
    private void CheckRotateRight()
    {
        ...
        {
            if (_gridHandler.GridArray[Mathf.RoundToInt(pos.x / 10) + 1, Mathf.RoundToInt((pos.z) / 10)] == 2 ||
                _gridHandler.GridArray[Mathf.RoundToInt(pos.x / 10) + 2, Mathf.RoundToInt((pos.z) / 10)] == 2 ||
                _gridHandler.GridArray[Mathf.RoundToInt(pos.x / 10) - 1, Mathf.RoundToInt((pos.z) / 10)] == 2)
            {
        ...
        if (rotater.TurnCounter == 1)
        {
            if (_gridHandler.GridArray[Mathf.RoundToInt(pos.x / 10), Mathf.RoundToInt((pos.z) / 10) + 1] == 2 ||
                _gridHandler.GridArray[Mathf.RoundToInt(pos.x / 10), Mathf.RoundToInt((pos.z) / 10) + 2] == 2 ||
                _gridHandler.GridArray[Mathf.RoundToInt(pos.x / 10), Mathf.RoundToInt((pos.z) / 10) - 1] == 2)
            {
                rotater.SetIsRightTurnAvailable(false);
